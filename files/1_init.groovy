...
jenkins_plugins="ant build-timeout credentials-binding email-ext gradle Snyk Dependency-Check workflow-aggregator ssh-slaves subversion timestamper ws-cleanup matrix-auth git"
